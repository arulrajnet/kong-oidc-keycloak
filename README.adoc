...
[%autowidth, grid=all]
|===
a|image::https://avatars0.githubusercontent.com/u/834529?s=70[alt="Follow @arulrajnet on Twitter", align="center", link="https://twitter.com/arulrajnet", window=_blank]
